...
- **Location**: Room 2000, Science and Engineering Hall [(Google Map)](https://maps.app.goo.gl/tLrgmMBWs3DbgHrFA)  
  ...
  - The building requires GW tap access for entry. In most cases, you can enter by following other GW students or faculty members entering or exiting the building. If you have difficulty gaining access, a contact phone number is posted at the entrance.

  - Upon entering the building, take the stairs or elevator to the second floor. Room 2000 will be directly in front of you.

  - **Note:** The meeting room has been changed from last year's location in the basement. 

- **Lodging:** Several hotels near campus are marked on the map below.
...
<!-- **Zoom Link:** https://gwu-edu.zoom.us/j/99596771550?pwd=kNKrc8E56Uhtr3dfCyM3ciUydx0u44.1-->
...
| time | topic | speaker |
| :--: | :----: | :----  |
| **8:50 - 9:00** | **opening remark** | leve |
| 9:00 - 9:30 | [stochastic hybrid system](files/2025/lee-review-2025.pdf) | lee  |
